...
"""
财务分析官 V1.0 实测脚本
- 加载 agents/prompts/finance_v1.md 作为 system prompt
- 依次运行 5 个测试案例，输出保存到 tests/finance/outputs/
用法: python run_finance_test.py [case编号 ...]
"""
import sys
import time
import json
...
PROMPT_FILE = ROOT / "agents" / "prompts" / "finance_v1.md"
